...
//  Can't use FusionAixComponentsFxDataFormProps until getPConnect().getChildren()[0] is fixed
// interface FusionAixComponentsFxDataFormProps extends PConnProps {
...
export default function FusionAixComponentsFxDataForm(props /* : FusionAixComponentsFxDataFormProps */) {
  registerIcon(check);
