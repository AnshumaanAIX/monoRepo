...
import FusionAixComponentsFxKanbanBoard from './index';

export default {
  title: 'Widgets/KanbanBoard02',
  argTypes: {
    detailsDataPage: {
      table: {
        disable: true
  ...
  component: FusionAixComponentsFxKanbanBoard
};
...
export const baseFusionAixComponentsFxKanbanBoard = {
  render: args => {
    setPCore();
    const props = {
      ...args,
    ...
    return <FusionAixComponentsFxKanbanBoard {...props} />;
  },
  args: {
