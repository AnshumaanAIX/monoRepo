...
import FusionAixComponentsFxCalendar from './index';
import React from 'react';

export default {
  title: 'Widgets/Calendar2sdk',
  argTypes: {
    dataPage: {
      table: {
        disable: true
  ...
  component: FusionAixComponentsFxCalendar
};
...
export const Default = {
  render: args => {
    ...
    return <FusionAixComponentsFxCalendar heading={''} dataPage={''} defaultViewMode={'Monthly'} nowIndicator={false} weekendIndicator={false} {...props} />;
  },
  args: {
    heading: 'Heading11111',
