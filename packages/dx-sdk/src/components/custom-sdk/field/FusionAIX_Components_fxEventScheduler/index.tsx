...
type FusionAixComponentsFxEventSchedulerProps = {
  getPConnect: any;
  value: string;
  hideLabel: boolean;
  testId?: string;
...
const FusionAixComponentsFxEventScheduler = (props: FusionAixComponentsFxEventSchedulerProps) => {
...
export default FusionAixComponentsFxEventScheduler;
