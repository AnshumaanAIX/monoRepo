import FusionAixComponentsFxCompareTableLayout from './index';
import { CurrencyDisplay } from '@pega/cosmos-react-core';

export default {
  title: 'Templates/Compare Table Layout01',
  argTypes: {
    selectionProperty: {
  ...
  component: FusionAixComponentsFxCompareTableLayout
};

const genComponent = (config, format) => {
...
const genResponse = (displayFormat, selectionProperty) => {
  const demoView = {
    name: 'demoView',
    type: 'View',
    config: {
...
// type Story = StoryObj<typeof FusionAixComponentsFxCompareTableLayout>;

const CompareTableDemo = (inputs) => {
  return {
    render: (args) => {
      (window).PCore = {
      ...
      return <FusionAixComponentsFxCompareTableLayout {...props}></FusionAixComponentsFxCompareTableLayout>;
    },
    args: inputs
  };
};

export const Default = CompareTableDemo({
  heading: 'Heading',
...
export const RadioButton = CompareTableDemo({
...
export const FinancialReport = CompareTableDemo({
