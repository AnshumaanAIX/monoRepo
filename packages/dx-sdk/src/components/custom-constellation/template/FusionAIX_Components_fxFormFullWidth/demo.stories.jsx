...
import FusionAixComponentsFxFormFullWidth from './index';

export default {
  title: 'Templates/Form full width01',
  argTypes: {
    getPConnect: {
      table: {
        disable: true
  ...
  component: FusionAixComponentsFxFormFullWidth
};
...
export const Default = {
  render: args => {
    ...
    return <FusionAixComponentsFxFormFullWidth {...props}>{regionAChildren}</FusionAixComponentsFxFormFullWidth>;
  },
  args: {
    heading: 'Heading',
    NumCols: '1'
