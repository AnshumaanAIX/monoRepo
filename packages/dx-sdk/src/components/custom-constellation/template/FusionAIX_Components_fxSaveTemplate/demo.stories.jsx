...
import FusionAixComponentsFxSaveTemplate from './index.jsx';
import { pyHome1Resolved, pyHome1Raw } from './mock.stories.js';

export default {
  title: 'FusionAixComponentsFxSaveTemplate',
  decorators: [withKnobs],
  component: FusionAixComponentsFxSaveTemplate
};

export const baseFusionAixComponentsFxSaveTemplate = () => {
  if (!window.PCore) {
    window.PCore = {};
  }
  ...
  return (
    <>
      <FusionAixComponentsFxSaveTemplate {...props}>{regionAChildren}</FusionAixComponentsFxSaveTemplate>
    </>
  );
};
