...
import FusionAixComponentsRdlInlinelayout from './index.jsx';
...
export default {
  title: 'FusionAixComponentsRdlInlinelayout',
  decorators: [withKnobs],
  component: FusionAixComponentsRdlInlinelayout
};
...
export const baseFusionAixComponentsRdlInlinelayout = () => {
  const props = {
    NumCols: 1,
  ...
  return (
    <>
      <FusionAixComponentsRdlInlinelayout {...props}>{regionAChildren}</FusionAixComponentsRdlInlinelayout>
    </>
  );
};
