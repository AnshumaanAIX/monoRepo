...
const FusionAixComponentsFxPicklist = props => {
  const {
    getPConnect,
    value,
    label,
...
FusionAixComponentsFxPicklist.defaultProps = {
  value: '',
  placeholder: '',
  validatemessage: '',
  hideLabel: false,
...
FusionAixComponentsFxPicklist.propTypes = {
...
export default FusionAixComponentsFxPicklist;
