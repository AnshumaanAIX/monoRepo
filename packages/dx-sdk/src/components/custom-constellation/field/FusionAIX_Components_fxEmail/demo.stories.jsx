...
import FusionAixComponentsFxEmail from './index.jsx';

export default {
  title: 'FusionAixComponentsFxEmail',
  decorators: [withKnobs],
  component: FusionAixComponentsFxEmail
};

export const baseFusionAixComponentsFxEmail = () => {
  ...
  return (
    <>
      <FusionAixComponentsFxEmail {...props} />
    </>
  );
};
