...
import FusionAixComponentsFxPhone from './index.jsx';

export default {
  title: 'FusionAixComponentsFxPhone',
  decorators: [withKnobs],
  component: FusionAixComponentsFxPhone
};

export const baseFusionAixComponentsFxPhone = () => {
  ...
  return (
    <>
      <FusionAixComponentsFxPhone {...props} />
    </>
  );
};
