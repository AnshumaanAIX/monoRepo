...
import FusionAixComponentsFxMenu from './index.jsx';

export default {
  title: 'FusionAixComponentsFxMenu',
  decorators: [withKnobs],
  component: FusionAixComponentsFxMenu
};

export const baseFusionAixComponentsFxMenu = () => {
  ...
  return (
    <>
      <FusionAixComponentsFxMenu {...props} />
    </>
  );
};
