...
import FusionAixFxRdlInlinelayoutFxRdlInlinelayout from './index.js';

export default {
  title: 'FusionAixFxRdlInlinelayoutFxRdlInlinelayout',
  decorators: [withKnobs],
  component: FusionAixFxRdlInlinelayoutFxRdlInlinelayout
};
...
export const BaseFusionAixFxRdlInlinelayoutFxRdlInlinelayout = () => {
  ...
  return (
    <>
      <FusionAixFxRdlInlinelayoutFxRdlInlinelayout {...props}></FusionAixFxRdlInlinelayoutFxRdlInlinelayout>
    </>
  );
};
