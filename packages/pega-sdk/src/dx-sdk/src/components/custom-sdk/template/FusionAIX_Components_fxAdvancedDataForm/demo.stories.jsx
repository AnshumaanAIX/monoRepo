...
import FusionAixComponentsFxAdvancedDataForm from './index.jsx';

export default {
  title: 'FusionAixComponentsFxAdvancedDataForm',
  decorators: [withKnobs],
  component: FusionAixComponentsFxAdvancedDataForm
};
...
export const BaseFusionAixComponentsFxAdvancedDataForm = () => {
  ...
  return (
    <>
      <FusionAixComponentsFxAdvancedDataForm {...props}></FusionAixComponentsFxAdvancedDataForm>
    </>
  );
};
