...
import { Select, Option, FieldValueList, Text, Button } from '@pega/cosmos-react-core';
import PropTypes from 'prop-types';

// includes in bundle
import { formatExists, textFormatter } from "./picklist";
import handleEvent from "./event-utils";
import { suggestionsHandler } from './suggestions-handler';

import StyledFusionAixComponentsFxMenuWrapper from './styles';
...
const FusionAixComponentsFxMenu = props => {
  const {
    getPConnect,
    value,
    label,
  ...
  if (displayMode === 'LABELS_LEFT' || displayMode === 'DISPLAY_ONLY') {
    ...
    return displayMode === 'DISPLAY_ONLY' ? (
      <StyledFusionAixComponentsFxMenuWrapper>
        displayComp
      </StyledFusionAixComponentsFxMenuWrapper>
    ) : (
      <StyledFusionAixComponentsFxMenuWrapper>
...
FusionAixComponentsFxMenu.defaultProps = {
  value: '',
  placeholder: '',
  validatemessage: '',
  hideLabel: false,
...
FusionAixComponentsFxMenu.propTypes = {
...
export default FusionAixComponentsFxMenu;
