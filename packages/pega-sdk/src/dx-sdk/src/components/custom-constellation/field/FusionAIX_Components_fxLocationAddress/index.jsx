...
const FusionAixComponentsFxLocationAddress = props => {
...
FusionAixComponentsFxLocationAddress.defaultProps = {
  value: '',
  placeholder: '',
  disabled: false,
  readOnly: false,
...
FusionAixComponentsFxLocationAddress.propTypes = {
...
export default FusionAixComponentsFxLocationAddress;
