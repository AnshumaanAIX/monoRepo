import FusionAixComponentsFxScheduler from './index';

export default {
  title: 'Fields/Scheduler01Constellation',
  argTypes: {
    getPConnect: {
      table: {
        disable: true
  ...
  component: FusionAixComponentsFxScheduler
};
...
export const Default = {
  render: args => {
    ...
    return <FusionAixComponentsFxScheduler {...props} />;
  },
  args: {
    eventDate: '20240215',
    startTime: '080000',
