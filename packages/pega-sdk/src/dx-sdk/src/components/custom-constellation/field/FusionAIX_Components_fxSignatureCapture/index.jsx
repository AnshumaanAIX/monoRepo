...
const FusionAixComponentsFxSignatureCapture = props => {
...
FusionAixComponentsFxSignatureCapture.defaultProps = {
  value: '',
  placeholder: '',
  disabled: false,
  readOnly: false,
...
FusionAixComponentsFxSignatureCapture.propTypes = {
...
export default FusionAixComponentsFxSignatureCapture;
