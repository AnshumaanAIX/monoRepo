...
export default function FusionAixComponentsFxAdvancedDataForm(props) {
...
FusionAixComponentsFxAdvancedDataForm.defaultProps = {
  value: '',
  placeholder: '',
  disabled: false,
  readOnly: false,
...
FusionAixComponentsFxAdvancedDataForm.propTypes = {
