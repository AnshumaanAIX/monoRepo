...
import FusionAixComponentsFxSearchLayout from './index.jsx';
...
export default {
  title: 'FusionAixComponentsFxSearchLayout',
  decorators: [withKnobs],
  component: FusionAixComponentsFxSearchLayout
};
...
export const baseFusionAixComponentsFxSearchLayout = () => {
  const props = {
    NumCols: 1,
  ...
  return (
    <>
      <FusionAixComponentsFxSearchLayout {...props}>{regionAChildren}</FusionAixComponentsFxSearchLayout>
    </>
  );
};
