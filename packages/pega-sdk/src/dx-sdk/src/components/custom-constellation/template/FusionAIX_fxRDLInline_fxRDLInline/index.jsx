...
import StyledFusionAixFxRdlInlineFxRdlInlineWrapper from './styles';
...
export default function FusionAixFxRdlInlineFxRdlInline(props) {
  ...
  return (
    <StyledFusionAixFxRdlInlineFxRdlInlineWrapper className='advanced-form-wrapper'>
    <Flex
    ...
    </StyledFusionAixFxRdlInlineFxRdlInlineWrapper>
  );

}

FusionAixFxRdlInlineFxRdlInline.defaultProps = {
  value: '',
  placeholder: '',
  disabled: false,
  readOnly: false,
...
FusionAixFxRdlInlineFxRdlInline.propTypes = {
