...
import FusionAixComponentsAdvanceForm from './index.jsx';
...
export default {
  title: 'FusionAixComponentsAdvanceForm',
  decorators: [withKnobs],
  component: FusionAixComponentsAdvanceForm
};
...
export const baseFusionAixComponentsAdvanceForm = () => {
  const props = {
    NumCols: 1,
  ...
  return (
    <>
      <FusionAixComponentsAdvanceForm {...props}>{regionAChildren}</FusionAixComponentsAdvanceForm>
    </>
  );
};
