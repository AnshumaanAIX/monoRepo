...
import FusionAixComponentsFxNetworkDiagram from './index';
import React from 'react';

export default {
  title: 'Widgets/Network Diagram01',
  argTypes: {
    dataPage: {
      table: {
        disable: true
  ...
  component: FusionAixComponentsFxNetworkDiagram
};
...
// type Story = StoryObj<typeof FusionAixComponentsFxNetworkDiagram>;
export const Default = {
  render: args => {
    ...
    return <FusionAixComponentsFxNetworkDiagram heading={''} height={''} showMinimap={false} showControls={false} showRefresh={false} edgePath={'bezier'} {...props} />;
  },
  args: {
    heading: 'Heading',
    height: '40rem',
